XOOPS 2.7.1 FINAL RELEASE

The XOOPS Development Team is pleased to announce the release of XOOPS 2.7.1.
This maintenance release strengthens security and upgrade handling, adds form
and theme improvements, refreshes bundled dependencies, and supports PHP 8.2
through PHP 8.5.

Download XOOPS 2.7.1 from GitHub: https://github.com/XOOPS/XoopsCore27/releases
...
Languages
-----------------------------------
XOOPS 2.7.1 is available in 37 community translations, maintained at:
