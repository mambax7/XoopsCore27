    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="breadcrumb">
                ...
                <li><a title="<{$node.cat_name}>"
                       href="<{xoAppUrl url='modules/extgallery/'}>public-categories.php?id=<{$node.cat_id}>"><{$node.cat_name}></a></li>
                <{/foreach}>
                <li><{$cat.cat_name}></li>
            </ul>
        </div>
        ...
        <div class="col-md-12 aligncenter orderbyicons">
            <ul class="list-unstyled">
                <li>
                    <a href="<{xoAppUrl url='modules/extgallery/'}>public-album.php?id=<{$extgalleryID}>&amp;start=<{$extgalleryStart}>&amp;sortby=photo_date&amp;orderby=DESC"
                    ...
                    <a href="<{xoAppUrl url='modules/extgallery/'}>public-album.php?id=<{$extgalleryID}>&amp;start=<{$extgalleryStart}>&amp;sortby=photo_date&amp;orderby=ASC"
                ...
                <li>
                    <a href="<{xoAppUrl url='modules/extgallery/'}>public-album.php?id=<{$extgalleryID}>&amp;start=<{$extgalleryStart}>&amp;sortby=photo_title&amp;orderby=ASC"
                       title="<{$smarty.const._MD_EXTGALLERY_SORTNAMEASC}>">
                        <span class="glyphicon glyphicon glyphicon-collapse-up"></span>
                    </a>
                    <span><{$smarty.const._MD_EXTGALLERY_SORTNAME}></span>
                    <a href="<{xoAppUrl url='modules/extgallery/'}>public-album.php?id=<{$extgalleryID}>&amp;start=<{$extgalleryStart}>&amp;sortby=photo_title&amp;orderby=DESC"
                ...
                <li>
                    <a href="<{xoAppUrl url='modules/extgallery/'}>public-album.php?id=<{$extgalleryID}>&amp;start=<{$extgalleryStart}>&amp;sortby=photo_hits&amp;orderby=DESC"
                       title="<{$smarty.const._MD_EXTGALLERY_SORTHITSDESC}>">
                        <span class="glyphicon glyphicon glyphicon-collapse-up"></span>
                    </a>
                    <span><{$smarty.const._MD_EXTGALLERY_SORTHITS}></span>
                    <a href="<{xoAppUrl url='modules/extgallery/'}>public-album.php?id=<{$extgalleryID}>&amp;start=<{$extgalleryStart}>&amp;sortby=photo_hits&amp;orderby=ASC"
                ...
                <li>
                    <a href="<{xoAppUrl url='modules/extgallery/'}>public-album.php?id=<{$extgalleryID}>&amp;start=<{$extgalleryStart}>&amp;sortby=photo_rating&amp;orderby=DESC"
                       title="<{$smarty.const._MD_EXTGALLERY_SORTNOTEDESC}>">
                        <span class="glyphicon glyphicon glyphicon-collapse-up"></span>
                    </a>
                    <span><{$smarty.const._MD_EXTGALLERY_SORTNOTE}></span>
                    <a href="<{xoAppUrl url='modules/extgallery/'}>public-album.php?id=<{$extgalleryID}>&amp;start=<{$extgalleryStart}>&amp;sortby=photo_rating&amp;orderby=ASC"
                ...
                <{if $photos[photo].photo_id}>
                    <ul class="adminlinks list-unstyled">
                        <{if isset($xoops_isadmin)}>
                            <li><a title="edit" href="<{xoAppUrl url='modules/extgallery/'}>public-modify.php?op=edit&id=<{$photos[photo].photo_id}>"><span
                                            class="glyphicon glyphicon-edit"></span></a></li>
                            <li><a title="delete" href="<{xoAppUrl url='modules/extgallery/'}>public-modify.php?op=delete&id=<{$photos[photo].photo_id}>"><span
                    ...
                    <{if isset($enableRating)}>
                        <div class="photoRating"><img src="<{xoAppUrl url='modules/extgallery/'}>assets/images/rating_<{$photos[photo].photo_rating}>.gif"
...
<{if isset($show_rss)}>
    <div id="rss">
        <a href="<{xoAppUrl url='modules/extgallery/public-rss.php?id='}><{$extgalleryID}>" title="<{$smarty.const._MD_EXTGALLERY_ALBUMRSS}>">
            <img src="<{xoAppUrl url='modules/extgallery/assets/images/feedblue.png'}>" alt="<{$smarty.const._MD_EXTGALLERY_ALBUMRSS}>"/></a>
        <a href="<{xoAppUrl url='modules/extgallery/public-rss.php'}>" title="<{$smarty.const._MD_EXTGALLERY_RSS}>">
            <img src="<{xoAppUrl url='modules/extgallery/assets/images/feed.png'}>" alt="<{$smarty.const._MD_EXTGALLERY_RSS}>"/></a>
    </div>
<{/if}>
