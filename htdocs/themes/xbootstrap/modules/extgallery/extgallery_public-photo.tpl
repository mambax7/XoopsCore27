<div class="row extGalleryAlbum">
    <div class="col-md-12">
        <ul class="breadcrumb">
            ...
            <li>
                <a href="<{xoAppUrl url='modules/extgallery/'}>public-<{if $node.cat_isalbum}><{$display_type}><{else}>categories<{/if}>.php?id=<{$node.cat_id}>"
                ...
                <{if isset($xoops_isadmin)}>
                    <div class="pull-left">
                        <a title="edit" class="btn btn-success btn-xs"
                           href="<{xoAppUrl url='modules/extgallery/'}>public-modify.php?op=edit&id=<{$photo.photo_id}>"><span
                                    class="glyphicon glyphicon-edit"></span></a>
                        <a title="delete" class="btn btn-danger btn-xs"
                           href="<{xoAppUrl url='modules/extgallery/'}>public-modify.php?op=delete&id=<{$photo.photo_id}>"><span
            ...
            <div class="col-xs-6 col-sm-6 col-md-6">
                <ul class="pull-right list-unstyled">
                    <{if isset($prevId) && $prevId != 0}>
                        <li class="nav-btn"><a href="<{xoAppUrl url='modules/extgallery/'}>public-photo.php?photoId=<{$prevId}>"><span
                    ...
                    <{if isset($nextId) && $nextId != 0}>
                        <li class="nav-btn"><a href="<{xoAppUrl url='modules/extgallery/'}>public-photo.php?photoId=<{$nextId}>"><span
        ...
        <div class="panel-collapse collapse" id="gallery-info">
            ...
            <ul class="list-unstyled photo-info">
                <{if isset($enable_submitter_lnk)}>
                    <li><{$lang.submitter}> : <a title="<{$photo.user.uname}>" href="<{$xoops_url}>/userinfo.php?uid=<{$photo.user.uid}>"><{$photo.user.uname}></a>
                        <a title="<{$lang.allPhotoBy}> <{$photo.user.uname}>"
                           href="<{xoAppUrl url='modules/extgallery/'}>public-useralbum.php?id=<{$photo.user.uid}>">
                ...
                <{if $canDownload && $enable_download}>
                    <li><a title="<{$lang.downloadOrig}>" href="<{xoAppUrl url='modules/extgallery/'}>public-download.php?id=<{$photo.photo_id}>"><{$lang.downloadOrig}><img
