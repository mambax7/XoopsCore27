<div class="row">
    <div class="col-md-12"><a title="<{$extgalleryName}>" href="<{xoAppUrl url='modules/extgallery/'}>"><h4><{$extgalleryName}></h4></a></div>
...
<div id="xoopsgrid" class="row">
    ...
    <div class="col-xs-6 col-sm-4 col-md-4 xoops-gallery-thumb">
        <{if $disp_cat_img == 1 }>
            <{if $child.cat_imgurl != "" }>
                <{if $child.cat_isalbum}>
                    <a title="<{$child.cat_name}>" href="<{xoAppUrl url='modules/extgallery/'}>public-<{$display_type}>.php?id=<{$child.cat_id}>">
                        <img src="<{$child.cat_imgurl}>" alt="<{$child.cat_name}>">
                    </a>
                <{else}>
                    <a title="<{$child.cat_name}>" href="<{xoAppUrl url='modules/extgallery/'}>public-categories.php?id=<{$child.cat_id}>">
                        <img src="<{$child.cat_imgurl}>" alt="<{$child.cat_name}>">
                    </a>
                <{/if}>
            <{else}>
        ...
        <{if $child.cat_isalbum}>
            <a title="<{$child.cat_name}>" href="<{xoAppUrl url='modules/extgallery/'}>public-<{$display_type}>.php?id=<{$child.cat_id}>" class="extgallery-album-name">
