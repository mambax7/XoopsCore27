...
<head>
	...
	<link rel="stylesheet" type="text/css" media="screen" href="<{xoAppUrl url='modules/system/css/admin.css'}>">
    <link rel="stylesheet" type="text/css" media="screen" href="<{xoAppUrl url='media/font-awesome/css/font-awesome.min.css'}>">
	<{if $bootstrap_css != ''}>
