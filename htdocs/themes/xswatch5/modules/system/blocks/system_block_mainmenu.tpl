<ul class="nav flex-column">
    <li class="nav-item">
        <a class="nav-link<{if empty($block.nothome)}> active<{/if}>" href="<{xoAppUrl url=' '}>" title="<{$block.lang_home}>"><span class="fa fa-home text-info fa-fw"></span> <{$block.lang_home}></a>
    </li>
