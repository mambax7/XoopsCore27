				...
				<div class="card-header">
					<h5>
						...
						<{if !empty($searchitem.module_show_all)}>
							...
							<span class="d-inline d-sm-none">| <span class="ms-2"></span><a href="<{$searchitem.module_show_all}>"><span class="fa-solid fa-magnifying-glass-plus fa-flip-horizontal fa-lg"></span></a></span>
						<{/if}>
					</h5>
				</div>
