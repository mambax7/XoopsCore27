...
function xoops_module_install_profile(XoopsModule $module)
{
    ...
    profile_install_addField('user_icq', _US_ICQ, '', 2, 'textbox', 1, 1, 0, [], 0, 255, false);
    profile_install_addField('user_aim', _US_AIM, '', 2, 'textbox', 1, 2, 0, [], 0, 255, false);
    profile_install_addField('user_yim', _US_YIM, '', 2, 'textbox', 1, 3, 0, [], 0, 255, false);
    profile_install_addField('user_msnm', _US_MSNM, '', 2, 'textbox', 1, 4, 0, [], 0, 255, false);
...
function profile_install_initializeProfiles()
{
    ...
    $GLOBALS['xoopsDB']->exec('   INSERT INTO ' . $GLOBALS['xoopsDB']->prefix('profile_profile') . ' (profile_id) ' . '   SELECT uid ' . '   FROM ' . $GLOBALS['xoopsDB']->prefix('users'));
...
function profile_install_setPermissions($field_id, $module_id, $canedit, $visible)
{
    ...
    $skip_icq_aim_yim_msnm = [8, 9, 10, 11];
