...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
      <img class="animation__shake" src="<{xoImgUrl url='images/icon_xoops.png'}>" alt="XOOPS" height="60" width="60">
    </div>
  </div>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<{xoAppUrl url='admin.php'}>" class="nav-link">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="left: inherit; right: 0px;">
          <a href="<{xoAppUrl url='user.php'}>" class="dropdown-item">
            <i class="fa fa-user mr-2"></i> <{$smarty.const._CPADMIN_VIEWACCOUNT}>
          </a>
          <div class="dropdown-divider"></div>
          <a href="<{xoAppUrl url='edituser.php'}>" class="dropdown-item">
            <i class="fa fa-pencil mr-2"></i> <{$smarty.const._CPADMIN_EDITACCOUNT}>
          </a>
          <div class="dropdown-divider"></div>
          <a href="<{xoAppUrl url='user.php?op=logout'}>" class="dropdown-item">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4 mb-2">
    <!-- Brand Logo -->
    <a href="<{xoAppUrl url='admin.php'}>" class="brand-link">
      <img src="<{xoImgUrl url='images/icon_xoops.png'}>" alt="XOOPS" class="brand-image img-circle elevation-3"
        style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<{xoAppUrl url='#'}>" class="nav-link">
