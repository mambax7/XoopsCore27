...
<div class="row">
    <div class="col">
        <div class="card card-default color-palette-box">
            <a class="text-dark" href="admin.php?fct=avatars&amp;op=listavt&amp;type=s" title="<{$smarty.const._AM_SYSTEM_AVATAR_SYSTEM}>">
    ...
    <div class="col">
        <div class="card card-default color-palette-box">
            <a class="text-dark" href="admin.php?fct=avatars&amp;op=listavt&amp;type=s" title="<{$smarty.const._AM_SYSTEM_AVATAR_CUSTOM}>">
                <div class="card-body text-center hoverable">
