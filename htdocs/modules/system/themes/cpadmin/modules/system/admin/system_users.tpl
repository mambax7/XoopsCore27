                    ...
                    <tr class="<{cycle values='even,odd'}> alignmiddle">
                        ...
                        <td class="xo-actions txtcenter">
                            <{if isset($user.user_level) && $user.user_level > 0}>
                                <img data-toggle="tooltip" onclick="display_post('<{$user.uid}>');" src="<{xoAdminIcons url='reload.png'}>"
                                ...
                                <img data-toggle="tooltip" src="<{xoAdminIcons url='display.png'}>" alt="<{$smarty.const._AM_SYSTEM_USERS_VIEW}>"
                                ...
                                <a data-toggle="tooltip" href="admin.php?fct=users&amp;op=users_edit&amp;uid=<{$user.uid}>"
                                   title="<{$smarty.const._AM_SYSTEM_USERS_EDIT}>">
                                    <img src="<{xoAdminIcons url='edit.png'}>" alt="<{$smarty.const._AM_SYSTEM_USERS_EDIT}>"/>
                                </a>
                                <a data-toggle="tooltip" href="admin.php?fct=users&amp;op=users_delete&amp;uid=<{$user.uid}>"
                                   title="<{$smarty.const._AM_SYSTEM_USERS_DEL}>">
                                    <img src="<{xoAdminIcons url='delete.png'}>" alt="<{$smarty.const._AM_SYSTEM_USERS_DEL}>"/>
                                </a>
                            <{else}>
