...
<div id="xo-system-icons">
    <div id="xo-icon">
        ...
        <{/foreach}>
        <a class="tooltip" href="<{xoAppUrl url='modules/system/admin.php'}>" title="<{$smarty.const._AM_SYSTEM_CONFIG}>">
            <img src='<{"$theme_icons/configuration.png"}>'/>
            <span><{$smarty.const._AM_SYSTEM_CONFIG}></span>
        </a>
        <a class="tooltip" href="<{xoAppUrl url='modules/system/help.php'}>" title="<{$smarty.const._AM_SYSTEM_HELP}>">
