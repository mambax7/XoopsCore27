...
define('_MD_AM_LDAP_FILTER_PERSON_DESC', "Special LDAP Filter to find user. @@loginname@@ is replace by the user's login name<br> MUST BE BLANK IF YOU DON'T KNOW WHAT YOU DO' !" . '<br>Ex : (&(objectclass=person)(samaccountname=@@loginname@@)) for AD' . '<br>Ex : (&(objectclass=inetOrgPerson)(uid=@@loginname@@)) for LDAP');
...
define('_MD_AM_TWOFACTORMODEDSC', 'Off pauses every second-factor challenge while keeping each member\'s enrolment. Optional lets members enrol a time-based code app and challenges members who have enrolled.');
