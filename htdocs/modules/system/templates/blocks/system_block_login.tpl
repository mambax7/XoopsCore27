<div class="txtcenter">
    <form style="margin-top: 0;" action="<{xoAppUrl url='user.php'}>" method="post">
    ...
    <br>
    <a href="<{xoAppUrl url='user.php#lost'}>" title="<{$block.lang_lostpass}>"><{$block.lang_lostpass}></a>
    <br><br>
    <a href="<{xoAppUrl url='register.php'}>" title="<{$block.lang_registernow}>"><{$block.lang_registernow}></a>
</div>
