    ...
    <{if !empty($xo_sys_help)}>
        <li class="xo-help">
            <a class="cursorhelp tooltip help_view" title="<{$smarty.const._AM_SYSTEM_HELP_VIEW}>"
               style="background-image:url('<{xoAdminNav}>bc_separator_end.png'); display: inline;"><img src="<{xoAdminIcons url='help.png'}>"
                                                                                                           alt="<{$smarty.const._AM_SYSTEM_HELP_VIEW}>"/></a>
            <a class="cursorhelp tooltip help_hide" title="<{$smarty.const._AM_SYSTEM_HELP_HIDE}>"
               style="background-image:url('<{xoAdminNav}>bc_separator_end.png');"><img src="<{xoAdminIcons url='help.png'}>"
...
<{if !empty($xo_sys_tips)}>
    <div class="tips ui-corner-all">
        <img class="floatleft tooltip" src="<{xoAdminIcons url='tips.png'}>" alt="<{$smarty.const._AM_SYSTEM_TIPS}>" title="<{$smarty.const._AM_SYSTEM_TIPS}>"/>
