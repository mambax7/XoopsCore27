...
<{if !empty($install_mods)}>
    ...
    <div class="floatleft">
        <img class="cursorpointer tooltip" onclick="system_moduleLargeView();" src="<{xoAdminIcons url='view_large.png'}>"
             alt="<{$smarty.const._AM_SYSTEM_MODULES_VIEWLARGE}>" title="<{$smarty.const._AM_SYSTEM_MODULES_VIEWLARGE}>"/>
        <img class="cursorpointer tooltip" onclick="system_moduleListView();" src="<{xoAdminIcons url='view_small.png'}>"
