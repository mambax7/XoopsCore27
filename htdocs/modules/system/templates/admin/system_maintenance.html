        ...
        <table class="outer ui-corner-all" cellspacing="1">
            ...
            <{if isset($verif_cache)}>
                <tr>
                    ...
                    <td class="aligntop txtcenter"><{if isset($result_cache)}><img width="16" src="<{xoAdminIcons url='success.png'}>"/><{else}><img style="width:16px;"
                                                                                                                                        src="<{xoAdminIcons url='cancel.png'}>"
                                                                                                                                        alt="Cancel"/><{/if}>
                    </td>
                </tr>
            <{/if}>
            ...
            <{if isset($verif_session)}>
                <tr>
                    ...
                    <td class="aligntop" align="center"><{if isset($result_session)}><img style="width:16px;" src="<{xoAdminIcons url='success.png'}>"
                                                                                   alt="Success"/><{else}><img style="width:16px;"
                                                                                                               src="<{xoAdminIcons url='cancel.png'}>" alt="Cancel"/><{/if}>
                    </td>
                </tr>
            <{/if}>
            ...
            <{if isset($verif_avatar)}>
                <tr>
                    ...
                    <td class="aligntop" align="center"><{if isset($result_avatar)}><img style="width:16px;" src="<{xoAdminIcons url='success.png'}>"
                                                                                  alt="Success"/><{else}><img style="width:16px;"
                                                                                                              src="<{xoAdminIcons url='cancel.png'}>" alt="Cancel"/><{/if}>
                    </td>
                </tr>
