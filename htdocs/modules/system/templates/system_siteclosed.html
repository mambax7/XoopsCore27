...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="<{xoAppUrl url='browse.php?xoops.css'}>"/>
...
<table class="collapse">
    <tr id="header">
        <td class="alignmiddle txtcenter" style="width: 150px; background-color: #2F5376;"><a href="<{xoAppUrl}>" title=""><img
                        src="<{xoAppUrl url='images/logo.gif'}>" alt=""/></a></td>
...
<form action="<{xoAppUrl url='user.php'}>" method="post">
